...
function App() {
  ...
  return (
    ...
    {/* Hero section */}
      <section>
        <div 
          className="text-white py-6 xs:!py-8 sm:!py-12 md:!py-16 lg:!py-20 px-4 xs:!px-6 sm:!px-8 md:!px-6 rounded-xl xs:!rounded-2xl sm:!rounded-[20px] md:!rounded-[30px] m-2 xs:!m-3 sm:!m-4 h-[300px] xs:!h-[350px] sm:!h-[400px] md:!h-[500px] lg:!h-[635px] bg-cover bg-center bg-no-repeat"
